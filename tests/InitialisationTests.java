...
public class InitialisationTests {
    ...
    public void setUp() throws Exception {
		//ScotlandYardModel sym = new ScotlandYardModel(5, {true, false, true, false}, "../test_resources/test_graph.txt");
		testLocationsMatchInitialLocationsAfterGameHasBeenInitialised();
